                        ...
                        >
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="pt-3 border-t border-slate-700 space-y-2">
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="text-gray-300 font-medium">{formatLargeNumber(coin.marketCap)}</span>
                                    </div>
                                    <div className="flex justify-between text-sm">
                                        <span className="text-gray-400">Volume (24h)</span>
                                        <span className="text-gray-300 font-medium">{formatLargeNumber(coin.volume24h)}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-4 h-12 flex items-end justify-between gap-1">
                                {[...Array(12)].map((_, i) => (
                                    <div
                                        key={i}
                                        className={`flex-1 rounded-t ${coin.change24h >= 0 ? 'bg-green-500/30' : 'bg-red-500/30'}`}
                                        style={{

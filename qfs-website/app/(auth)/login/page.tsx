            ...
            <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4 py-16">
                ...
                >
                    ...
                    <p className="text-gray-300 mb-8">
                        You have successfully logged in to your QFS account. Redirecting to dashboard...
                    </p>
                ...
                >
                    ...
                    <div className="text-center mb-8">
                        <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-full">
                            ...
                            <span className="text-blue-400 text-sm">Quantum Secured Login</span>
                        </div>
                        <h1 className="text-4xl font-bold text-white mb-2">Welcome Back</h1>
                        <p className="text-gray-300">Sign in to access your QFS account</p>
                    </div>
                    ...
                    <div className="bg-slate-900/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-8">
                        ...
                        <div className="relative mb-6">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-4 bg-slate-900/50 text-gray-400">Or sign in with email</span>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <button
                                ...
                                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold py-3 rounded-xl transition-all shadow-lg shadow-blue-500/20 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {isSubmitting ? (
                    ...
                    <div className="mt-6 grid grid-cols-2 gap-4">
                        ...
                        <div className="p-4 bg-slate-800/50 border border-slate-700 rounded-xl text-center">
                            ...
                            <p className="text-xs text-gray-400">Quantum-Resistant Security</p>
                        </div>
                    </div>
                    ...
                    <div className="mt-6 p-4 bg-slate-800/50 border border-slate-700 rounded-xl">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="text-sm text-gray-400">
                                <p className="font-medium text-white mb-1">Secure Login</p>
                                <p>
                                    Your credentials are protected with quantum-resistant encryption. We never store your password in plain text.
                                </p>
                            </div>
                        </div>
                    </div>
